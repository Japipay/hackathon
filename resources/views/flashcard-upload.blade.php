...
<head>
    ...
    <title>Flashcard Generator - NoteAlly</title>
...
<body class="bg-gray-900 text-white">
    ...
    <div class="main-container w-full max-w-4xl">
        <h2 class="text-3xl font-bold mb-6 text-center"><i class="fas fa-file-pdf text-red-500"></i> Flashcard Generator</h2>
        ...
        <div class="card mb-6">
            ...
            <form action="{{ route('generate.flashcards') }}" method="POST" enctype="multipart/form-data" id="flashcardsForm">
                ...
                <h5 class="text-lg font-semibold text-white mb-4 text-center">Flashcard Options</h5>
                <div class="mb-3">
        ...
        <div class="card mt-6">
            ...
            <ol class="list-decimal pl-6 text-gray-400 space-y-2">
                ...
                <li>Choose the number of flashcards and difficulty level</li>
                <li>Click "Generate Flashcards" to get AI-processed flashcards</li>
            </ol>
        </div>
    </div>
